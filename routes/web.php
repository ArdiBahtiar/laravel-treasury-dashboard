...
Route::get('/activate', 'App\Http\Controllers\IndexController@indexActivate')->middleware('auth');
...
Route::post('/activate/redeem', 'App\Http\Controllers\VoucherController@redeemVoucher')->middleware('auth');
Route::get('/activate/confirm/{vocer}', 'App\Http\Controllers\VoucherController@confirmVoucher')->middleware('auth');
